...
public:
	//FUNCTION PROTOTYPES
	ImageProcessing();
	ImageProcessing(double ip_CV2_IMAGE_MAX_X_1, double ip_CV2_IMAGE_MAX_Y_1, double ip_CV2_IMAGE_MIN_X_1, double ip_CV2_IMAGE_MIN_Y_1, double ip_CV2_IMAGE_MAX_X_2, double ip_CV2_IMAGE_MAX_Y_2, double ip_CV2_IMAGE_MIN_X_2, double ip_CV2_IMAGE_MIN_Y_2);
	~ImageProcessing();

	//############## MULTI-THREAD REGULAR FUNCTIONS################//
	unsigned			__stdcall analyzeProfile(void* args);
	unsigned			__stdcall templateMatch(void* data);
	void				setLaserCorrectionAngles(double leftLaser, double rightLaser);
};
